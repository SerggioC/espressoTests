...
public class OrderSummaryActivityTest {
    ...
    // DONE (2) Add the rule that indicates we want to use Espresso-Intents APIs
    // in functional UI tests (IntentsTestRule)
    @Rule
    ...
    public void getStrings() {
        ...
        email_message = resources.getString(R.string.email_message);
    }
